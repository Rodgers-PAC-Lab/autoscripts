# rsync the video data from octopus to cuttlefish
#
# Run like this:
# /bin/bash -l -c 'cd /home/mouse/dev/autoscripts/octopus_nightly_rsync; python3 octopus_nightly_rsync.py >> logfile 2>&1'
...
output_dir = os.path.join(
    check_cuttlefish_mount_dir, 'octopus')

# Copy behavior
input_dir = '/home/mouse/Desktop/sleap_local'
