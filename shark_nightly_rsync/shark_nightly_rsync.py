# rsync data from shark to cuttlefish
# * ~/open-ephys
# * ~/octopilot
# * ~/Videos
#
# Run like this:
# /bin/bash -l -c 'cd /home/mouse/dev/autoscripts/shark_nightly_rsync; python3 shark_nightly_rsync.py >> logfile 2>&1'
