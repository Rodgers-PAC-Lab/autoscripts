# rsync the video data from jellyfish to cuttlefish
#
# Run like this:
# /bin/bash -l -c 'cd /home/mouse/dev/autoscripts/jellyfish_nightly_rsync; python jellyfish_nightly_rsync.py >> logfile 2>&1'
...
output_dir = os.path.join(
    check_cuttlefish_mount_dir, 'behavior', 'videos', 'e3vision')
