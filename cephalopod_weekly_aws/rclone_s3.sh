...
rclone copy --fast-list --log-file=rclone.log --log-level INFO ~/mnt/cuttlefish/christina remote:emory-rodgerslab-backup-hot-20221205/christina
rclone copy --fast-list --log-file=rclone.log --log-level INFO ~/mnt/cuttlefish/cici remote:emory-rodgerslab-backup-hot-20221205/cici
...
rclone copy --fast-list --log-file=rclone.log --log-level INFO ~/mnt/cuttlefish/jessica remote:emory-rodgerslab-backup-hot-20221205/jessica
...
rclone copy --fast-list --log-file=rclone.log --log-level INFO ~/mnt/cuttlefish/octopus remote:emory-rodgerslab-backup-hot-20221205/octopus
...
rclone copy --fast-list --log-file=rclone.log --log-level INFO ~/mnt/cuttlefish/shrimp remote:emory-rodgerslab-backup-hot-20221205/shrimp
